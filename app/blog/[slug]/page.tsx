...
import { 
  Calendar, User, ArrowLeft, Share2, ChevronLeft, ChevronRight,
...
export default function BlogPostPage() {
  ...
  useEffect(() => {
    // Get products related to the blog post content
    const allProducts = getAllProducts();
    const postContent = post ? (post.title + ' ' + post.excerpt_text).toLowerCase() : '';
    
    // Filter products based on blog content
